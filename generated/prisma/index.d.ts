...
export namespace Prisma {
  ...
  */
            ...
            Post: {
                ...
                operations: {
                    ...
                    count: {
                        ...
                        result:
                            | $Utils.Optional<PostCountAggregateOutputType>
                            | number;
                    };
                };
            };
    ...
    type GetPostGroupByPayload<T extends PostGroupByArgs> =
        Prisma.PrismaPromise<
            Array<
                PickEnumerable<PostGroupByOutputType, T["by"]> & {
                    [P in keyof T &
                        keyof PostGroupByOutputType]: P extends "_count"
                        ? T[P] extends boolean
                            ? number
    ...
    > {
        ...
        >(
            args: SubsetIntersection<T, PostGroupByArgs, OrderByArg> &
                InputErrors,
        ): {} extends InputErrors
