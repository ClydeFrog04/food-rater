        ...
        y = class t extends Uint8Array {
            ...
            toString(e = "utf8", r = 0, n = this.length) {
                if (
                    ...
                    return "";
                if (e === "utf8" || e === "utf-8")
                    return zs.decode(this.slice(r, n));
                if (e === "base64" || e === "base64url") {
...
function ni(t, e) {
    ...
    if (
        ...
        for (
            i = f.length, a = A.length, R = i < a, R && (a = i), i = 0;
            i < a;
            i++
        )
            if (f[i] != A[i]) {
    ...
    qi.exports = (function () {
        ...
        return function (e, r) {
            ...
            var a = 0,
                ...
                te = [];
            for (f = 0; f < i; f++)
                (te.push(f + 1), te.push(e.charCodeAt(s + f)));
            ...
            for (; a < o; )
                for (
                    k = r.charCodeAt(s + (v = a)), C = ++a, f = 0;
                    f < Oe;
                    f += 2
                )
                    ((L = te[f]),
                        (te[f] = C = t(L, v, C, k, te[f + 1])),
                        (v = L));
            return C;
        };
    })();
...
var mr = (t, e = new ln()) => {
        let r = {
            ...
            startTransaction: async (...n) =>
                (await Pe(e, t.startTransaction.bind(t))(...n)).map((o) =>
                    Na(e, o),
                ),
        };
        return (
...
async function Tu(t, e) {
    ...
    if (t.includes("accelerate") && n !== "0.0.0" && n !== "in-memory")
        return n;
    let [i, o] = n?.split("-") ?? [];
    ...
    Zt = class {
            ...
            (this.startPromise !== void 0 && (await this.startPromise),
                (this.startPromise = (async () => {
                    ...
                    ((this.host = r.host),
                        ...
                        (this.remoteClientVersion = await ns(
                            this.host,
                            this.config,
                        )),
                        Xt("host", this.host),
        ...
        propagateResponseExtensions(e) {
            (e?.logs?.length &&
                ...
                e?.traces?.length &&
                    this.tracingHelper.dispatchEngineSpans(e.traces));
        }
        onBeforeExit() {
            throw new Error(
...
var er = class {
    ...
    async stop() {
        if (
            ...
            return (
                be("library is already stopping"),
                this.libraryStoppingPromise
            );
...
${a.backtrace}`,
    ...
    getExternalAdapterError(e, r) {
        if (e.error_code === Ru && r) {
            ...
            return (
                yr(i, "External error with reported id was not registered"),
                i
            );
        }
    }
...
var Qn =
        ...
        (r) => {
            ...
            if (Lr(r))
                ...
                let [o, ...s] = r;
                ((n = o),
                    (i = { values: ft(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (e) {
                    case "sqlite":
                    case "mysql": {
