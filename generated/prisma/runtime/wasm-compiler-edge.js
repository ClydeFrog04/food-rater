        ...
        h = class e extends Uint8Array {
            ...
            toString(t = "utf8", r = 0, n = this.length) {
                if (
                    ...
                    return "";
                if (t === "utf8" || t === "utf-8")
                    return fu.decode(this.slice(r, n));
                if (t === "base64" || t === "base64url") {
...
var Ii = me((SP, _s) => {
    ...
    _s.exports = (function () {
        ...
        return function (t, r) {
            ...
            for (; a < o; )
                for (
                    M = r.charCodeAt(s + (w = a)), C = ++a, f = 0;
                    f < Ke;
                    f += 2
                )
                    ((L = pe[f]),
                        (pe[f] = C = e(L, w, C, M, pe[f + 1])),
                        (w = L));
            return C;
        };
    })();
...
async function Jd() {
    return (
        globalThis.crypto ?? (await Promise.resolve().then(() => (Xe(), xi)))
    );
}
async function uc() {
            ...
            (this.startPromise !== void 0 && (await this.startPromise),
                (this.startPromise = (async () => {
                    ...
                    ((this.host = r.host),
                        ...
                        (this.remoteClientVersion = await vc(
                            this.host,
                            this.config,
                        )),
                        Hr("host", this.host),
